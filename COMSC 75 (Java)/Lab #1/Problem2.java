 ...
 * But sometimes the error messages are misleading. Over time you will develop a sense for when you can trust the compiler 
 * and when you have to figure things out yourself.
 * Starting with the Hello World program from the book, 
 * try out each of the following errors. After you make each change, compile the program, read the error message (if there is one), 
